      ...
      <div className={`relative group bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 border transition-all ${
        ...
        <div className="relative mb-3">
          {participant.user.avatar ? (
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 mx-auto flex items-center justify-center text-2xl font-bold">
            ...
            {showMenu && (
              <div className="absolute right-0 mt-1 w-48 bg-gray-800 rounded-lg shadow-xl py-1 z-10 border border-gray-700">
                <button
                  ...
                  className="w-full px-4 py-2 text-left hover:bg-gray-700 text-sm flex items-center"
                >
                  {participant.isMuted ? (
                    <>
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left hover:bg-gray-700 text-sm flex items-center text-red-400"
                >
